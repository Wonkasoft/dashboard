...
<html lang="en">
  <head>
    ...
    <title>Dashboard - Wonkasoft Server</title>
      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          <ul class="nav navbar-nav side-nav">
            ...
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-caret-square-o-down"></i> Misc Settings <b class="caret"></b></a>
          ...
          <ul class="nav navbar-nav navbar-right navbar-user">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="message-preview">
                  <a href="#">
                    ...
                    <span class="name">Devturtle: </span>
            ...
            <li class="dropdown user-dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> Devturtle <b class="caret"></b></a>
              <ul class="dropdown-menu">
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              <li class="active"><i class="fa fa-dashboard"></i> Wonkasoft Dashboard v<?php echo phpversion(); ?></li>
            </ol>
          </div>
        </div><!-- /.row -->
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-bar-chart-o"></i> Development Projects</h3>
              </div>
              <div class="panel-body">
                <div id="morris-chart-area">
                    ...
                    for ($i = 0; $i < sizeof($dirs); $i++) {
                        $appPath = explode('/', $dirs[ $i ]);
                        $appPath = end($appPath);
                        $module  = '';
                        if ($appPath !== 'dashboard' && $appPath !== 'webalizer' && $appPath !== 'img' && $appPath !== 'xampp') {
                            echo '<div class="col-lg-4"><h3>' . $appPath . '</h3><a href="/' . $appPath . '" class="btn btn-sm btn-primary">View Site</a> <a href="/' . $appPath . '/wp-admin/" class="btn btn-sm btn-info">Admin Login</a> <a href="#" class="btn btn-sm btn-danger">Delete</a></div>';
                        }
                    }
                    ?>
                </div>
