			  ...
			  <div class="panel-body">
				<div id="morris-chart-area">
					...
					for ( $i = 0; $i < sizeof( $dirs ); $i++ ) {
						...
						if ( $appPath[4] !== 'dashboard' && $appPath[4] !== 'webalizer' && $appPath[4] !== 'img' ) {
							echo '<div class="col-lg-4"><h3>' . $appPath[4] . '</h3><a href="/' . $appPath[4] . '" class="btn btn-sm btn-primary">View Site</a> <a href="/' . $appPath[4] . '/wp-admin/" class="btn btn-sm btn-info">Admin Login</a> <a href="#" class="btn btn-sm btn-danger">Delete</a></div>';
						}
					}
					?>
				</div>
